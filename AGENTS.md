# Compare two folder trees and find duplicate folders — in the browser, no install (`duplicate-folder-finder-web`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://duplicate-folder-finder-web.sociobot.in`. Artifact class: `pwa-offline`.
